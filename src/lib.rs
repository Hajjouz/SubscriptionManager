// src/lib.rs
/*
 * Core library for SubscriptionManager
 */
...
#[derive(Debug)]
pub struct SubscriptionManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SubscriptionManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SubscriptionManager processing");
    
    let mut processor = SubscriptionManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SubscriptionManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SubscriptionManagerProcessor::new(false);
